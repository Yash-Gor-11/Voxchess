...
console.log("Desired quality:", desired);
console.log(
  "Initial candidate:",
  candidate.move,
  "| score:",
  ...
  candidate.move,
  "| quality:",
  currentPool.find(c => c.pv === candidate)?.quality,
  "| score:",
  candidate.score,
  "| mate:",
  candidate.mate,
  ...
  console.log("✅ Accepted:", candidate.move);
  return candidate;
}
console.log("❌ Rejected:", candidate.move);
...
const next = resolveUpwardFallback(currentPool, desired);

console.log(
  "Fallback chose:",
  next.move,
  currentPool.find(c => c.pv === next)?.quality,
);
