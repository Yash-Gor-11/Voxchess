...
function allocate(e, r, t, n) {
  ...
  if (
    ((a =
      t == ALLOC_NONE ? n : [_malloc, stackAlloc, dynamicAlloc][t](Math.max(i, s ? 1 : r.length))),
    o)
  ) {
    var u;
...
function getBinaryPromise() {
  return wasmBinary || (!ENVIRONMENT_IS_WEB && !ENVIRONMENT_IS_WORKER) || "function" != typeof fetch
...
(isDataURI(wasmBinaryFile) || (wasmBinaryFile = locateFile(wasmBinaryFile)),
  (Module.asm = function (e, r, t) {
    return (
      (r.memory = wasmMemory),
      (r.table = wasmTable =
        new WebAssembly.Table({ initial: 733, maximum: 733, element: "anyfunc" })),
...
var PATH = {
      ...
      mmap: function (e, r, t, n, o, i, a) {
        ...
        if (2 & a || (l.buffer !== r && l.buffer !== r.buffer)) {
          ((0 < o || o + n < e.node.usedBytes) &&
            (l = l.subarray ? l.subarray(o, o + n) : Array.prototype.slice.call(l, o, o + n)),
            (u = !0));
    ...
    getDB: function (e, r) {
      ...
      ((t.onupgradeneeded = function (e) {
        ...
        (r = t.objectStoreNames.contains(IDBFS.DB_STORE_NAME)
          ...
          : t.createObjectStore(IDBFS.DB_STORE_NAME)).indexNames.contains("timestamp") ||
      ...
      IDBFS.getDB(e.mountpoint, function (e, t) {
        ...
        try {
          ...
          ((r.onerror = function (e) {
            ...
            (r.objectStore(IDBFS.DB_STORE_NAME).index("timestamp").openKeyCursor().onsuccess =
              function (e) {
  ...
  WORKERFS = {
    ...
    stream_ops: {
      ...
      llseek: function (e, r, t) {
        var n = r;
        if (
          (1 === t ? (n += e.position) : 2 === t && FS.isFile(e.node.mode) && (n += e.node.size),
          n < 0)
        )
          throw new FS.ErrnoError(22);
        return n;
  ...
  FS = {
    ...
    mount: function (e, r, t) {
      ...
      return (
        ((u.mount = s).root = u),
        o ? (FS.root = u) : n && ((n.mounted = s), n.mount && n.mount.mounts.push(s)),
        u
      );
    },
    unmount: function (e) {
    ...
    truncate: function (e, r) {
      ...
      var t;
      "string" == typeof e ? (t = FS.lookupPath(e, { follow: !0 }).node) : (t = e);
    ...
    open: function (r, e, t, n, o) {
      ...
      (u.stream_ops.open && u.stream_ops.open(u),
        !Module.logReadFiles ||
          ...
          r in FS.readFiles ||
            ((FS.readFiles[r] = 1), console.log("FS.trackingDelegate error on read file: " + r))));
      try {
    ...
    write: function (r, e, t, n, o, i) {
      ...
      try {
        ...
        console.log(
          "FS.trackingDelegate['onWriteToFile']('" + r.path + "') threw an exception: " + e.message,
        );
      }
      return s;
    },
              ...
              void 0 === a.chunks[e] &&
                (a.chunks[e] = (function (e, r) {
                  ...
                  if (
                    ...
                    throw new Error("Couldn't load " + s + ". Status: " + t.status);
  ...
  SYSCALLS = {
    ...
    doStat: function (e, r, t) {
      try {
        ...
        if (e && e.node && PATH.normalize(r) !== PATH.normalize(FS.getPath(e.node))) return -20;
        throw e;
      }
      return (
        (HEAP32[t >> 2] = n.dev),
...
function _emscripten_set_main_loop_timing(e, r) {
  if (
    ((Browser.mainLoop.timingMode = e), (Browser.mainLoop.timingValue = r), !Browser.mainLoop.func)
  )
    return 1;
  if (0 == e)
        ...
        if (0 < Browser.mainLoop.queue.length) {
          ...
          if ((r.func(r.arg), Browser.mainLoop.remainingBlockers)) {
            ...
            r.counted
              ...
              : ((n += 0.5), (Browser.mainLoop.remainingBlockers = (8 * t + n) / 9));
          }
          if (
            (console.log('main loop blocker "' + r.name + '" took ' + (Date.now() - e) + " ms"),
    ...
    runIter: function (e) {
      if (!ABORT) {
        ...
        try {
          ...
          throw (
            e && "object" == typeof e && e.stack && err("exception thrown: " + [e, e.stack]),
            e
          );
        }
      ...
      var e = {
        ...
        handle: function (r, t, n, o) {
          ...
          if (Browser.hasBlobConstructor)
            try {
              (e = new Blob([r], { type: Browser.getMimetype(t) })).size !== r.length &&
                (e = new Blob([new Uint8Array(r).buffer], { type: Browser.getMimetype(t) }));
            } catch (e) {
              warnOnce(
  ...
  updateCanvasDimensions: function (e, r, t) {
    ...
    Browser.resizeCanvas
      ? (e.width != n && (e.width = n),
        ...
        void 0 !== e.style && (e.style.removeProperty("width"), e.style.removeProperty("height")))
      : (e.width != r && (e.width = r),
...
function _emscripten_async_call(e, r, t) {
  ...
  ((Module.noExitRuntime = !0),
    0 <= t ? Browser.safeSetTimeout(n, t) : Browser.safeRequestAnimationFrame(n));
}
  ...
  return 0 === e
    ...
    : ((e = UTF8ToString(e)),
      ENV.hasOwnProperty(e)
        ? (_getenv.ret && _free(_getenv.ret), (_getenv.ret = allocateUTF8(ENV[e])), _getenv.ret)
        : 0);
}
  ...
  var _ = {
    ...
    "%j": function (e) {
      return f(
        e.tm_mday +
          __arraySum(
            __isLeapYear(e.tm_year + 1900) ? __MONTH_DAYS_LEAP : __MONTH_DAYS_REGULAR,
            e.tm_mon - 1,
          ),
        3,
      );
    ...
    "%U": function (e) {
      ...
      if (m(t, n) < 0) {
        var o =
            __arraySum(
              __isLeapYear(n.getFullYear()) ? __MONTH_DAYS_LEAP : __MONTH_DAYS_REGULAR,
              n.getMonth() - 1,
            ) - 31,
...
function exit(e, r) {
  (r && Module.noExitRuntime && 0 === e) ||
    (Module.noExitRuntime ||
      ((ABORT = !0), (EXITSTATUS = e), exitRuntime(), Module.onExit && Module.onExit(e)),
